...
fill("white")
textSize(15)
text("A T A D A S B A", 1130,260)
fill("lightblue")
text("Hint: Always changing, not constant !!", 1130,280)

fill("white")
textSize(15)
text("C U T N I F O N", 100,460)
fill("lightblue")
text("Hint: Always changing, not constant !!", 100,480)
